...
export default function FacebookCard({ item }) {
      ...
      <View style={{ padding: '2.5%', alignItems: 'flex-start' }}>
        <>
          <View style={{ flexDirection: 'row', justifyContent: 'center', borderRadius: 7, paddingHorizontal: '2%', }}>
            ...
            <FontAwesome5 name="facebook-square" size={RFPercentage(4.9)} color="#313131" />
          ...
          <View style={{ flex: 1, width: '100%', }}>
            <WebView
              style={{ height: 300, width: '100%', opacity: 0.99 }}
              source={{
                html: item.actLink
              }}
              scalesPageToFit={false}
            />
            {/* <YoutubePlayer height={300} play={false} videoId={'Uq9gPaIzbe8'} webViewStyle={{ opacity: 0.99 }} /> */}
            {/* <Video
              resizeMode='contain'
              useNativeControls
              ref={video}
